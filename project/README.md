...
***
### Цель:
простая цель: организовать L2 и L3 связность между двумя ЦОД находящихся в изолированных доменах для возможности миграции ВМ продуктива между ЦОД

Уточненная цель:
- Организовать резервирование сервисов, находящихся в продуктиве (vrf BLUE), между двумя ЦОД на уровне L2 и L3.
- Организовать взаимодействие сервисов между двумя ЦОД на уровне L3 в пределах своих vrf напрямую
